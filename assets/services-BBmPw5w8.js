const SERVICES = [
  {
    ...
    title_es: "Marketing de Contenidos",
    ...
    shortDesc_es: "Escritura de contenido médico confiable y atractivo que refuerza su posición como experto en su campo médico.",
    tagline_en: "Build Trust Through Knowledge",
    tagline_ar: "بناء الثقة من خلال المعرفة",
    tagline_es: "Construye Confianza a través del Conocimiento",
    ...
    description_es: "Nuestro servicio de marketing de contenidos crea artículos educativos y optimizados para SEO que establecen su clínica como una autoridad confiable en atención médica.",
  ...
  },
  {
    ...
    title_es: "Gestión de Servicio al Cliente",
    shortDesc_en: "Transform patient interactions into positive experiences.",
    shortDesc_ar: "تحويل تفاعلات المريض إلى تجارب إيجابية.",
    shortDesc_es: "Un equipo especializado para responder a las consultas de los pacientes y programar citas para garantizar la satisfacción y la lealtad.",
    tagline_en: "Excellence in Patient Care",
    tagline_ar: "التميز في رعاية المريض",
    tagline_es: "Excelencia en la Atención al Paciente",
    ...
    description_es: "Gestionamos sus operaciones de servicio al cliente con profesionales capacitados, asegurando que cada interacción del paciente refleje el compromiso de su clínica con la excelencia.",
  ...
  },
  {
    ...
    title_es: "Gestión de Comercio Electrónico",
    ...
    shortDesc_es: "Soluciones completas para vender productos y suministros médicos en línea con una experiencia de usuario perfecta.",
    tagline_en: "Turn Browsers into Buyers",
    tagline_ar: "تحويل المتصفحين إلى مشترين",
    tagline_es: "Convierte Visitantes en Compradores",
    ...
    description_es: "Desde la configuración hasta la optimización, gestionamos su tienda en línea completa de productos médicos con pagos seguros y gestión de inventario.",
  ...
  },
  {
    ...
    title_es: "Marketing en Redes Sociales",
    ...
    shortDesc_es: "Gestión integrada de cuentas de redes sociales para aumentar la conciencia de su clínica y atraer a más pacientes.",
    tagline_en: "Connect. Engage. Grow.",
    tagline_ar: "الاتصال. الارتباط. النمو.",
    tagline_es: "Conectar. Involucrar. Crecer.",
    ...
    description_es: "Creamos y gestionamos su presencia en redes sociales en todas las plataformas, construyendo confianza, participación y lealtad de los pacientes.",
  ...
  },
  {
    ...
    title_es: "Entrenamiento del Equipo de Marketing",
    shortDesc_en: "Empower your team with cutting-edge marketing skills.",
    shortDesc_ar: "دعّم فريقك بمهارات تسويق متقدمة.",
    shortDesc_es: "Programas de capacitación especializados para desarrollar las habilidades de su equipo de marketing interno.",
    tagline_en: "Knowledge is Power",
    tagline_ar: "المعرفة قوة",
    tagline_es: "El Conocimiento es Poder",
    ...
    description_es: "Nuestros programas de capacitación integrales equipan a su equipo con las últimas estrategias de marketing de atención médica.",
  ...
  },
  {
    ...
    title_es: "Desarrollo de Web y App Móvil",
    ...
    shortDesc_es: "Desarrollo de sitios web médicos profesionales y aplicaciones móviles garantizando una experiencia de usuario distintiva y reservas fáciles.",
    tagline_en: "Build. Convert. Grow.",
    tagline_ar: "بناء. تحويل. نمو.",
    tagline_es: "Construir. Convertir. Crecer.",
    ...
    description_es: "Sitios web y aplicaciones móviles a medida diseñados específicamente para proveedores de atención médica.",
